    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(nullable: false),
                    HairSalonId = table.Column<int>(nullable: false),
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favourites", x => new { x.UserId, x.HairSalonId });
                    table.ForeignKey(
                        name: "FK_Favourites_HairSalons_HairSalonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_HairSalons_HairSalonId",
                        column: x => x.HairSalonId,
                        principalTable: "HairSalons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservations", x => new { x.Id, x.HairSalonId, x.UserId });
                    table.ForeignKey(
                        name: "FK_Reservations_HairSalons_HairSalonId",
                        column: x => x.HairSalonId,
                        principalTable: "HairSalons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.UserId, x.HairSalonId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkingHours_HairSalons_HairSalonId",
                        column: x => x.HairSalonId,
                        principalTable: "HairSalons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_HairSalonId",
                table: "Favourites",
                column: "HairSalonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_HairSalonId",
                table: "Images",
                column: "HairSalonId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_HairSalonId",
                table: "Reservations",
                column: "HairSalonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingHours_HairSalonId",
                table: "WorkingHours",
                column: "HairSalonId");
        }
